...
class LoginView(SuccessURLAllowedHostsMixin, FormView, TemplateView):
    """
    ...
    def get_redirect_url(self):
        ...
        redirect_to = self.redirect_url if self.redirect_url else self.request.POST.get(
...
class PasswordResetView(PasswordContextMixin, FormView):
    email_template_name = 'website/base_templates/password_reset_email.html'
