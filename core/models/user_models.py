...
class CustomUser(AbstractUser):
    ...
    image = models.ImageField(upload_to='media', verbose_name='Immagine del profilo', null=True, default='user_default.jpg')
    def __str__(self):
...
class Trainer(models.Model):
    ...
    # def __init__(self):
    #     return self.details.get_group_permissions('istruttore')