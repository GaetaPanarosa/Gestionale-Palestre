...
from control_panel.forms.course_form import *
...
from core.models import Course, Hours, Trainer, CourseDay
...
class CourseManagement(FormView):
    ...
    def details_course(request, pk):
        template_name = 'control_panel/course/detail_course.html'
...
class CourseTable(BaseDatatableView):
    model = Course
    columns = ['name', 'start_date', 'end_date', 'price', 'traienr', 'details', 'disable']
...
class CourseDisactivatedTable(BaseDatatableView):
    model = Course
    columns = ['name', 'start_date', 'end_date', 'price', 'traienr', 'details', 'enable']
    order_columns = ['name', 'start_date', 'end_date', 'price', 'trainer', '', '']
